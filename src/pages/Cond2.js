...
const Cond1 = () => {
    ...
    // await fetch("http://localhost:4001/getcond2")
    await fetch("https://visharad-backend.onrender.com/getcond2")
        .then(response => {
    ...
    return (
        <div className='App'>
            <div className='flex justify-center m-2'>
                ...
                <p className='text-[18px] mt-auto mb-auto'>&nbsp; Male Users which have phone price greater than 10,000.</p>
            </div>
            <div className='flex justify-center m-2'>
